                       ...
                       int privileged)
{
    ...
    // 0 means no block seated, which is what the trusted entry's refusal path keys on; the
                       ...
                       void* stack_base, size_t stack_size)
{
    ...
    // the thread carries 0 through its own teardown and every trap on the way takes the
