...
namespace
{
    ...
    constexpr int TIM2_IRQ = 28;               // NVIC position 28 = TIM2 (RM0365)
...
// wrap while the tickless timer is disarmed and no thread reads the clock;
// tim2_ticks folds it into g_clk_high (idempotent vs a concurrent thread read).
