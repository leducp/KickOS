...
/*
 * Per-board provisioning for the FRDM-K64F (MK64FN1M0). See stm32f103's
 * board_config.h for the mechanism. Large SRAM (256 KiB). Pure integer macros
...
#define KICKOS_MAX_IRQ 86 /* K64: IRQ0..85 */
#endif
