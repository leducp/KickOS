...
/* kickos_thread_return on a privileged thread's own stack with an interrupt nested below. 1200
 * on qemu-arm64-benchgicv3 and benchsmp12, down EXITK's chain. NEST + 1216 = 2784 is what sets
...
/* A privileged fault's reporter, kickos_armv8a_exception, on the stack that faulted. 1216 on
 * qemu-arm64-benchgicv3 and benchsmp12: kprintf[560] into the console and the kernel lock under
 * it. */
#define KICKOS_ARMV8A_TRAP_DEPTH_FAULT 1216
