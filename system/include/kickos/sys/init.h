...
// custom init composes the two in whatever order it needs. CALL IT LAST: any bring-up
// sequenced after it runs with the app's narrowed set and earns -KOS_EPERM.
