...
//
// The per-board pin-mux map. The default init applies it BEFORE the console
// bring-up: it is the DAG middle of the clock->pinmux->gpio bring-up chain. Each
...
// kickos_board_console. See system/init/pinmap_none.cc and a per-board provider such
