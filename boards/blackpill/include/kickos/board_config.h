 ...
 * No on-board debugger, so it flashes over USB-DFU (hold BOOT0) or an external SWD
 * probe -- see docs/reference/boards.md, which is also where this port's validation
 * status is recorded.
 */
