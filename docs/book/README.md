...
| 4 | Per-ISA guided tour | armv7m / armv6m / RXv3 / RV32IMAC / Xtensa LX6: context switch, trap entry, timer, IRQ controller | `arch/*/` code; worked example drafted: [`porting-a-new-isa-riscv.md`](porting-a-new-isa-riscv.md) |
