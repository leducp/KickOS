...
> [`../design-m7-smp.md`](../design-m7-smp.md) for the multicore primitive, which
...
compare-and-swap instruction on a third. [`../design-m7-smp.md`](../design-m7-smp.md)
...
- The multicore primitive a critical section would be built from, per part:
  [`../design-m7-smp.md`](../design-m7-smp.md).
